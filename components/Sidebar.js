      ...
      >
        <BsFillArrowLeftSquareFill
          className={`absolute cursor-pointer -right-3 top-9 w-9 h-9 border-green-700
           border-2 rounded-lg text-white bg-green-700 hover:text-gray-100 ${!open && "rotate-180"}`}
          onClick={() => setOpen(!open)}
        />
        <div className="flex gap-x-4 items-center">
          <GiCoffeeBeans
            className={`w-9 h-9 text-white duration-300 ${
              open && "scale-100"
            }`}
          />
          <h1
        ...
        <div className='justify-start my-4 border-b border-gray-100 pb-4 pt-4 w-auto'>
            <Link href='/dashboard'>
                <div className='flex rounded-md p-2 cursor-pointer hover:bg-green-800 text-gray-300 text-sm items-center gap-x-4'>
        ...
        <div className='w-auto'>
            <Link href='/login'>
                <div className='flex rounded-md p-2 cursor-pointer hover:bg-green-800 text-gray-300 text-sm items-center gap-x-4 border border-gray-200'>
